...
public class MealTestData {
    ...
    public static final Meal mealAdmin1 = new Meal(MEAL1_ID + 7, LocalDateTime.of(2020, Month.JANUARY, 31, 14, 0), "Админ ланч", 510);
    public static final Meal mealAdmin2 = new Meal(MEAL1_ID + 8, LocalDateTime.of(2020, Month.JANUARY, 31, 21, 0), "Админ ужин", 1500);
